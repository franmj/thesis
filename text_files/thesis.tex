...
\item  \textbf{Martínez-Jiménez, F.}, Overington J. P., Al-Lazikani B., $\&$ Marti-Renom, M. a. (2016). \textbf{Rational design of non-resistant targeted cancer therapies}. Nucleic Acids Research.  (\textit{Submitted}). 

\item \textbf{Martínez-Jiménez, F.*}, $\&$ Marti-Renom, M. A. (2016). \textbf{Should network biology be used for drug discovery?} Expert Opinion on Drug Discovery, 1–3. http://doi.org/10.1080/17460441.2016.1236786
...
\par There are many computational methods to predict the 3D structure of proteins (Table \ref{table:table_software}). Each of these methods have their own strengths and weakness and none of them clearly outperform the others for all cases.
...
\textbf{Martínez-Jiménez, F.}, Overington J. P., Al-Lazikani B., $\&$ Marti-Renom, M. a. (2016). \textbf{Rational design of non-resistant targeted cancer therapies}. Nucleic Acids Research. (\textit{Submitted}). 
\hfill
\vspace*{7mm}
\end{tcolorbox}

\includepdf[pages=-,pagecommand={\thispagestyle{plain}},width=\textwidth]{../figures/20160928_Rational_FMJ_MAMR.pdf}
