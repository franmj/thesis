...
\par The likelihood model and the resistance predictor are also susceptible to be improved.  As mentioned before, the likelihood predictions are average-based. The average do not necessarily represent particular cases and therefore, the estimations may lose individual trends. However, including information about the patient's genetic profile, such as pre-existing somatic mutations, germline variations or the individual mutational signatures; would give a more personalized estimation of the mutational likelihood. \\
The resistance predictor may also incorporate new features. For instance, the development a classifier allowing double or triple mutants. To do so, we would need a training set including such types of mutants, which at this moment is too narrow.\\ 
