...
\hline
 ...
 \hline
 Database &  TDRtargets & Database and method for idenfication of potential MTB targets & \cite{Crowther2010} \\
 \hline   
 Application of bioinformatics tools & -  & Drug repositioning applied to MDR-TB and XDR-TB & \cite{Kinnings2009}  \\
 \hline
  Database &  CDD-TB & Database of MTB reported screenings alongside computational models to analyze the data  &   \cite{Ekins2010}  \\
 \hline
 Application of bioinformatics and chemoinformatics tools & -  & Identification of MTB targets anti-tubercular compounds using three orthogonal approaches & \cite{Martinez-Jimenez2013, Rebollo-Lopez2015}   \\ 
 \hline
  Application of bioinformatics tools &  -  & Homology modelling and virtual doking for ligand-protein interaction prediction & \cite{DeJonge2007} \\
 \hline
 Application of chemoinfomatics tools & TB Mobile &   Mobile app that displays and allows interaction with data collected from CDD-TB & \cite{Ekins2013, Clark2014} \\
 \hline 
   ...
   \hline
    Application of bioinformatics tools & - &  Interactome analysis to identify potential mechanisms of drug resistance & \cite{Raman2008} \\
   \hline
